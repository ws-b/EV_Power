...
# Set file path
#path = 'D:\Data\대학교 자료\켄텍 자료\삼성미래과제\Driving Pattern\Drive Cycle' #only for Windows
path = '/Users/woojin/Downloads/경로데이터 샘플 및 데이터 정의서/포인트 경로 데이터 속도:가속도 처리/'
file = '164_2.csv'
...
ax.stackplot(t, P_e, P_b, P_a, P_c, P_d, labels=['Pe','Pb','Pa','Pc','Pd'])
ax.legend(loc='upper right', bbox_to_anchor=(1.11, 1.0), fontsize=12)
ax.set_xlabel('Time(minutes)', fontsize=20, labelpad=13)
