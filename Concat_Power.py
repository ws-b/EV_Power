import os
import numpy as np
from total_distance_triptime import get_file_list
"""
# 파일이 들어있는 폴더 경로
win_folder_path =''
...
file_path = '/Users/woojin/Downloads/경로데이터 샘플 및 데이터 정의서/포인트 경로 데이터 속도:가속도 처리/'
file = '164_2.csv'
data = np.loadtxt(file_path+file, delimiter=',', dtype=np.float64)
